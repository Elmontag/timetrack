    ...
    <div className="rounded-xl border border-slate-800 bg-slate-900/70 p-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400">Importierte Termine des Tages.</p>
        </div>
        <span className="text-xs uppercase tracking-wide text-slate-500">{dayjs(day).format('DD.MM')}</span>
      </div>
